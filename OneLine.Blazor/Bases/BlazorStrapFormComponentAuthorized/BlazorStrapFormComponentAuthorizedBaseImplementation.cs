...
namespace OneLine.Blazor.Bases
{
    ...
    public abstract partial class BlazorStrapFormComponentAuthorizedBase<T, TIdentifier, TId, THttpService, TBlobData, TBlobValidator, TUserBlobs> :
        ...
        where TUserBlobs : class, IUserBlobs
    {
        ...
        /// </summary>
        public BlazorStrapFormComponentAuthorizedBase() : base()
        {
