...
namespace OneLine.Bases
{
    ...
    {
        ResponseResult<ApiResponse<Paged<IEnumerable<T>>>> ResponsePaged { get; set; }
        Action<ResponseResult<ApiResponse<Paged<IEnumerable<T>>>>> ResponsePagedChanged { get; set; }
    }
}
