...
namespace Xamarin.Essentials.Implementation
{
    ...
    //}
    //public class GeolocationImplementation : IGeolocation
    //{
    ...
    //}
    //public class GyroscopeImplementation : IGyroscope
    //{
    ...
    //    }
    //}
    //public class LauncherImplementation : ILauncher
    //{
    ...
    //         => Xamarin.Essentials.Launcher.TryOpenAsync(uri);
    //}
    //public class MagnetometerImplementation : IMagnetometer
    //{
    ...
    //    }
    //}
    //public class MainThreadImplementation : IMainThread
    //{
    ...
    //}
    //public class OrientationSensorImplementation : IOrientationSensor
    //{
    ...
    public class SecureStorageImplementation : ISecureStorage
    {
        ...
        async Task<bool> ISecureStorage.Remove(string key)
             => Xamarin.Essentials.SecureStorage.Remove(key);

        async Task ISecureStorage.RemoveAll()
    ...
    //}
    //public class VibrationImplementation : IVibration
    //{
