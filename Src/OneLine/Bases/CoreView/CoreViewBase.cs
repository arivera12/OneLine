...
//            if (FormMode.IsSingle())
//            {
//                return Record.GetType().GetProperties().Where(w => w.PropertyType == typeof(Mutable<FormFileRules, IEnumerable<BlobData>, IEnumerable<TUserBlobs>>));
//            }
//            else if (FormMode.IsMultiple())
//            {
...
//                foreach (var record in Records)
//                {
//                    foreach (var property in record.GetType().GetProperties().Where(w => w.PropertyType == typeof(Mutable<FormFileRules, IEnumerable<BlobData>, IEnumerable<TUserBlobs>>)))
//                    {
