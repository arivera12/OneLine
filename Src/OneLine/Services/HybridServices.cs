...
namespace OneLine.Services
{
    ...
    {
        /// <summary>
        /// Adds the current services <see cref="IApplicationConfigurationSource"/>, 
        /// <see cref="ISupportedCultures"/>, 
        /// <see cref="IApplicationConfiguration"/>, 
        /// <see cref="IResourceManagerLocalizer"/>, 
        /// <see cref="IApplicationState"/>,
        /// <see cref="IDevice"/>
        /// <see cref="IDeviceStorage"/>,
        /// <see cref="ISaveFile"/>,
